...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".summary-footer {\r\n  display: flex;\r\n  align-items: flex-end;\r\n  flex-direction: column;\r\n}\r\n", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,aAAa;EACb,qBAAqB;EACrB,sBAAsB;AACxB","sourcesContent":[".summary-footer {\r\n  display: flex;\r\n  align-items: flex-end;\r\n  flex-direction: column;\r\n}\r\n"],"sourceRoot":""}]);
// Exports
...
/* harmony export */ });
/* harmony import */ var _ActivityList_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ActivityList.js */ "./src/ActivityList.js");
/* harmony import */ var _StateManager_Js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./StateManager.Js */ "./src/StateManager.Js");
/* harmony import */ var _DayView__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./DayView */ "./src/DayView.js");
/* harmony import */ var _SummaryActivityView__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./SummaryActivityView */ "./src/SummaryActivityView.js");
...
class Controller {
  constructor() {
    this.activityList = new _ActivityList_js__WEBPACK_IMPORTED_MODULE_0__.default()
    this.dayView = new _DayView__WEBPACK_IMPORTED_MODULE_2__.default(
      this.activityList.getActivities(_StateManager_Js__WEBPACK_IMPORTED_MODULE_1__.default.getCurrentDay())
    )
    this.summaryView = new _SummaryActivityView__WEBPACK_IMPORTED_MODULE_3__.default()
  }
...
/* harmony export */ });
/* harmony import */ var _ActivityView__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ActivityView */ "./src/ActivityView.js");
...
class DayView {
  ...
  render() {
    ...
    this.morningActivity = new _ActivityView__WEBPACK_IMPORTED_MODULE_0__.default("morning", this.props.morning)
    this.morningActivity.render()

    this.eveningActivity = new _ActivityView__WEBPACK_IMPORTED_MODULE_0__.default("evening", this.props.evening)
  ...
  update(props) {
    this.el.querySelector("#dayName").innerHTML = _Utils__WEBPACK_IMPORTED_MODULE_1__.default.getDayName(
      _StateManager_Js__WEBPACK_IMPORTED_MODULE_2__.default.getCurrentDay()
    )
  ...
  onNext() {
    _StateManager_Js__WEBPACK_IMPORTED_MODULE_2__.default.goToNextDay()
    _app__WEBPACK_IMPORTED_MODULE_3__.default.updateDay()
  }

  onPrev() {
    _StateManager_Js__WEBPACK_IMPORTED_MODULE_2__.default.gotoPrevDay()
    _app__WEBPACK_IMPORTED_MODULE_3__.default.updateDay()
  }

  onSummary() {
    _StateManager_Js__WEBPACK_IMPORTED_MODULE_2__.default.saveDay(this.getData())
    _app__WEBPACK_IMPORTED_MODULE_3__.default.toggleSummary()
  }
...
class StateManager {
  ...
  static saveDay(data) {
    _app__WEBPACK_IMPORTED_MODULE_0__.default.activityList.setActivity(StateManager._currentDay, data)
  }
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ SummaryActivityView)
/* harmony export */ });
/* harmony import */ var _app__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./app */ "./src/app.js");
/* harmony import */ var _Utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Utils */ "./src/Utils.js");
...
class SummaryActivityView {
  ...
  update() {
    ...
    _app__WEBPACK_IMPORTED_MODULE_0__.default.activityList.data.forEach((activity, idx) => {
      const name = _Utils__WEBPACK_IMPORTED_MODULE_1__.default.getDayName(idx)
...
const controller = new _Controller__WEBPACK_IMPORTED_MODULE_1__.default()
